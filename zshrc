...
plugins=(git git-prompt zsh-syntax-highlighting history-substring-search tmux web-search common-aliases zsh-completions history fnm z zsh-autosuggestions sudo)
